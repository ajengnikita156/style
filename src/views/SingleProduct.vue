                            ...
                            <div class="lg:order-2 lg:ml-5">
                                <div class="max-w-xl overflow-hidden rounded-lg">
                                    <img class="h-full w-full max-w-full object-cover"
                                        src="https://i.pinimg.com/236x/a4/27/63/a427633b708edc49c3cec523ad110058.jpg" style="width: 530px;"
                                        alt="" />
                                </div>
                            </div>
                    ...
                    <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        ...
                        <div
                            ...
                            <div class="flex items-end">
                                <h1 class="text-3xl font-bold">{{ formatRupiah(product.base_price) }}</h1> 
