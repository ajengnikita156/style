<template>
  <div style="margin-top: 105px;">
    <center><img src="../assets/img/ceklis.png" style="width: 150px" /></center>
  </div>
    ...
    <div class="overflow-y-hidden rounded-lg border">
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead>
            <tr
              class="text-left text-xs font-semibold uppercase tracking-widest text-white"
          ...
          <tbody class="text-gray-500">
            <tr>
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                <p class="whitespace-no-wrap" style="color: black">
                  <b>Order Code :</b>
                </p>
              </td>
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                <p class="whitespace-no-wrap">
                  {{ formatRupiah(getOrder.orders[0].grand_total) }}
                </p>
              </td>
            </tr>
            <tr>
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tr>
            ...
            <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
              <span
                class="rounded-full bg-yellow-200 px-3 py-1 text-xs font-semibold text-yellow-900"
                >{{ formatRupiah(getOrder.grand_total) }}</span
              >
            </td>
          </tr>
          <tr>
          ...
          <tr
            class="bg-blue-600 text-right text-xs font-semibold uppercase tracking-widest text-white"
          >
            <th class="px-5 py-2" colspan="4">Total</th>
            <th class="px-5 py-3">
              {{ formatRupiah(getOrder.grand_total + 15000) }}
            </th>
          </tr>
        </table>
      </div>
