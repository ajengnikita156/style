      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">stylecollection@gmail.com</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="#">style.mu collection</a>
          ...
          <li class="my-6 flex items-center text-left">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">081298761234</p>
              <span class="block text-xs uppercase">number phone</span>
            </div>
          </li>
        </ul>
      </div>
