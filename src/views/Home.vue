  ...
  <div class="dark:text-white" style="margin-top: 30px">
    <div class="flex flex-col">
      <div class="px-4 w-full xl:max-w-7xl xl:mx-auto">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-9">
          <p class="text-gray-900 text-2xl title-font font-medium mb-4 ml-3">
            Flash Sale
          </p>
          <div class="grid md:grid-cols-3 gap-8">
            <div
              v-for="product in getFlashProduct"
              :key="product.id"
            ...
            >
              ...
              >
                <img
                  class="object-cover w-full rounded-t-lg md:h-auto ml-4 md:w-28 md:rounded-none md:rounded-l-lg"
                ...
                <div class="flex flex-col justify-between p-4 leading-normal">
                  ...
                  {{ product.name }}
                  <p
                    class="text-sm font-bold text-gray-600 truncate block capitalize mt-2 mb-4"
                  >
                    {{ formatRupiah(product.base_price) }}
                  </p>
                  <div class="flex items-center">
                    <p
                      class="text-sm font-bold text-black truncate block capitalize mt-2"
                    >
                      Lets Buy
                    </p>
                    <svg
        ...
        <!-- Kategori -->
        <div class="p-4 border my-2 dark:border-gray-900 shadow-md rounded-2xl">
          ...
          >
            <div
              ...
              class="snap-center rounded-xl duration-500 hover:scale-105 hover:shadow-xl"
            >
              <RouterLink to="#">
                <div
 ...
 <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-9">
        ...
        <div class="p-4 border my-2 dark:border-gray-600 shadow-md rounded-2xl">
          ...
          <div
            class="p-3 snap-mandatory snap-x flex overflow-auto no-scrollbar"
          >
            <div v-for="brand in getBrand.data.slice(0, 8)" class="snap-center rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
              <RouterLink to="#">
                <div
                  class="mx-4 py-7 px-2 border w-56 rounded-lg hover:bg-gray-200 hover:shadow-md hover:dark:bg-gray-700 dark:border-gray-700 transition-all"
                >
...
export default {
  computed: {
    ...mapGetters("product", ["getProduct", "getFlashProduct"]),
    ...mapGetters("brand", ["getBrand"]),
    ...mapGetters("kategori", ["getKategori"]),
  },
  methods: {
    ...mapActions("product", ["fetchProduct", "fetchFlashProduct"]),
  ...
  created() {
    this.fetchProduct(), this.fetchFlashProduct();
  },
};
</script>
